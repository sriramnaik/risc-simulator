...
public:
    ...
    // Updated interface with float awareness
    ForwardingSource GetRs1Source(
        bool ex_reg_write, uint8_t ex_rd,
        bool mem_reg_write, uint8_t mem_rd,
        uint8_t rs1,
        bool is_float_rs1 = false,      // Is rs1 reading from FPR?
        bool ex_is_float = false,       // Is EX/MEM writing to FPR?
        bool mem_is_float = false       // Is MEM/WB writing to FPR?
        ) const;

    ForwardingSource GetRs2Source(
        bool ex_reg_write, uint8_t ex_rd,
        bool mem_reg_write, uint8_t mem_rd,
        uint8_t rs2,
        bool is_float_rs2 = false,
        bool ex_is_float = false,
        bool mem_is_float = false
        ) const;
};
