...
//     // *** ADD EXPLICIT LOAD/STORE HANDLING HERE ***
...
//         return;  // Don't run ALU or other logic
//     }
...
//         return_address_ = program_counter_;  // PC is already incremented, this is return address
//         if (opcode == 0b1100111) {
//             // JALR: jump to rs1 + imm, set PC directly
//             program_counter_ = execution_result_ & ~1;  // Clear LSB per RISC-V spec
//         } else {
//             // JAL: jump to PC + imm
//             program_counter_ = instruction_pc_ + imm;
//         }
//         next_pc_ = return_address_;  // For writeback
//     }
