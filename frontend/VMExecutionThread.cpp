...
//                vm_->GetProgramCounter() < vm_->GetProgramSize() &&
//                instruction_count < max_instructions_) {

//             // Check if pipeline is empty (for pipelined VM)
//             if (vm_->GetProgramCounter() >= vm_->GetProgramSize() &&
//                 vm_->IsPipelineEmpty()) {
//                 break;
//             }
...
//             // Emit signal periodically for GUI updates (every 100 instructions)
...
//             emit executionError(
//                 QString("Execution stopped: Maximum instruction limit (%1) reached.\n"
